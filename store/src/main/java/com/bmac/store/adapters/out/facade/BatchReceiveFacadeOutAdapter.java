...
@Profile("facade")
@Component
public class BatchReceiveFacadeOutAdapter implements BatchForwardPort {
    private final Logger log = LoggerFactory.getLogger(getClass());
    private final ReceiveBatchFacade facade;

    @Autowired
    public BatchReceiveFacadeOutAdapter(@Autowired(required = false) ReceiveBatchFacade facade) {
        this.facade = facade;
    }
